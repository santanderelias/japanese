        ...
        this.container.innerHTML = `
            <div class="home-dashboard fade-in">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 mb-2">
                        <div class="card h-100 menu-card border-0 shadow-sm" onclick="window.navigateApp('study')">
                            <div class="card-body d-flex align-items-center p-3 p-md-4">
                                <div class="icon-box bg-info bg-opacity-10 text-info rounded-circle me-3 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                    <i class="bi bi-journal-richtext fs-4"></i>
                                </div>
                                <div>
                                    <h5 class="card-title mb-1">Study Materials</h5>
                                    <p class="card-text text-muted small mb-0">Grammar guides and vocabulary.</p>
                                </div>
                    ...
                    <!-- Exercises Grid (2 per row on mobile = col-6) -->
                    <!-- Verb Conjugation -->
                    <div class="col-6 col-md-6 col-lg-3">
                        <div class="card h-100 menu-card border-0 shadow-sm" onclick="window.navigateApp('filler')">
                            <div class="card-body text-center p-3 p-md-4">
                                ...
                                <h5 class="card-title mb-1 fs-6 fs-md-5">Verb Conjugation</h5>
                                <p class="card-text text-muted small d-none d-md-block">Practice polite forms</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6 col-lg-3">
                        <div class="card h-100 menu-card border-0 shadow-sm" onclick="window.navigateApp('particles')">
                            <div class="card-body text-center p-3 p-md-4">
                                ...
                                <h5 class="card-title mb-1 fs-6 fs-md-5">Particle Quiz</h5>
                                <p class="card-text text-muted small d-none d-md-block">Master wa, ga, ni, de</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6 col-lg-3">
                        <div class="card h-100 menu-card border-0 shadow-sm" onclick="window.navigateApp('reorder')">
                            <div class="card-body text-center p-3 p-md-4">
                                <div class="icon-box bg-warning bg-opacity-10 text-dark rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                    <i class="bi bi-list-ol fs-3"></i>
                                </div>
                                <h5 class="card-title mb-1 fs-6 fs-md-5">Sentence Builder</h5>
                                <p class="card-text text-muted small d-none d-md-block">Unscramble sentences</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6 col-lg-3">
                        <div class="card h-100 menu-card border-0 shadow-sm" onclick="window.navigateApp('kanji')">
                            <div class="card-body text-center p-3 p-md-4">
                                ...
                                <h5 class="card-title mb-1 fs-6 fs-md-5">Kanji Match</h5>
                                <p class="card-text text-muted small d-none d-md-block">Match Kanji to Kana</p>
                            </div>
                        </div>
                    </div>
                </div>
